...
const TABLE_COLUMNS = {
  ...
  collection_payments: ['Payment_ID','Sale_ID','Sale_Code','Type','Plot_Shop_Number','Town_Name','Customer_Name','Agent_Name','Amount','Received_Before','Received_After','Remaining_After','Payment_Date','Payment_Method','Notes','Payment_Account_ID','Payment_Account_Name','Payment_Account_Type'],
...
function mapDailyEntryToCloud(row) {
  ...
  return {
    ...
    Account_Name: String(r.Account_Name || r.accountName || ''),
    Account_Type: String(r.Account_Type || r.accountType || ''),
...
function mapDailyEntryFromCloud(row) {
  return {
    ...
    Town_Name: getRowVal(row, 'Town_Name') || '',
    Account_Name: getRowVal(row, 'Account_Name') || '',
    Account_Type: getRowVal(row, 'Account_Type') || '',
